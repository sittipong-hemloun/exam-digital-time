...
export const FeedbackButton = memo(function FeedbackButton({
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-30 flex items-center gap-2 px-4 py-3 rounded-full backdrop-blur-lg border ${theme === "dark" ? "border-white" : "border-black"} transition-all duration-300 hover:scale-105 ${
        theme === "dark"
